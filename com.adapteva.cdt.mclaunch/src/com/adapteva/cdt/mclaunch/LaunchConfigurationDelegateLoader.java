...
public class LaunchConfigurationDelegateLoader extends AbstractCLaunchDelegate {
	...
	public void launch(ILaunchConfiguration configuration, String mode,
		...
		boolean doReset = configuration.getAttribute(MCLaunchConstants.MC_LOADER_LAUNCH_ATTR_DO_RESET, MCLaunchConstants.MC_LAUNCH_DEFAULT_DO_RESET);
		boolean doRun = configuration.getAttribute(MCLaunchConstants.MC_LOADER_LAUNCH_ATTR_DO_RUN, MCLaunchConstants.MC_LAUNCH_DEFAULT_DO_RUN);
		...
		cmdLine += " -server_host_addr " + hostIpAddr;
		
		cmdLine += " -server_port " + portNum;
